...
public class EntropyWeightMethodTest {
    public double[][] doubles = {
        {1.000, 3.000, 3.000, 4.000, 5.000,
            4.000, 4.000, 3.000, 5.000, 7.000,
            4.000, 4.000, 8.000, 7.000, 6.000, 3.000, 4.000},

        {1.000, 2.000, 3.000, 1.000, 2.000,
                2.000, 3.000, 4.000, 3.000, 6.000,
                5.000, 3.000, 7.000, 6.000, 6.000, 2.000, 4.000},

        {1.000, 1.000, 1.000, 3.000, 2.000,
                5.000, 2.000, 1.000, 6.000, 4.000,
                2.000, 4.000, 7.000, 9.000, 10.000, 5.000, 5.000},
    };

    public double[] targetScoreArray =
            {3.000, 3.000, 5.000, 4.000, 5.000,
            7.000, 5.000, 5.000, 6.000, 7.000,
            5.000, 5.000, 10.000, 10.000, 10.000, 5.000, 5.000};
    ...
    public void test(){
        ...
        //1.1求每列最大、小值
        double[][] maxAndMinMatrix = new double[2][column]; //第一行最大值、第二行最小值
        //i->行,j->列
        ...
        double tmp = 0.0;
        for(int j=0;j<column;j++){
            tmp += metricsWeightArray[j];
            System.out.println(metricsWeightArray[j]);
        }
        System.out.println("总值:"+tmp);
    }
}
